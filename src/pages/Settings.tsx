...
import { ArrowLeft, User, CreditCard, Crown } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-secondary">
      ...
      <div className="max-w-4xl mx-auto px-4 pt-24 pb-16 animate-fade-in">
        ...
        <div className="space-y-6">
          ...
          {/* Subscription Info */}
          <Card className="backdrop-blur-sm bg-card/50 border-border/50 animate-scale-in" style={{ animationDelay: "0.1s" }}>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
